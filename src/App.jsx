...
const ACTIVITIES = {
  breakfast: [
    { name: 'Grand Central Market',  desc: '100年続く屋台フードホール。Eggslutのサンドが人気',  area: 'DTLA',         distance: '徒歩 5分',  mode: 'walk', icon: Coffee, cat: 'food',    rating: 4.6, price: '$10~', scene: 'food_breakfast', hours: '8:00-22:00', dayBadge: { text: '営業中', kind: 'open' }, url: 'https://grandcentralmarket.com', insta: '@grandcentralmarket' },
    { name: 'Sqirl',                 desc: 'リコッタトーストとジャム瓶で有名なカフェ',         area: 'Silver Lake',  distance: '車 15分',   mode: 'car',  icon: Coffee, cat: 'food',    rating: 4.5, price: '$15~', scene: 'food_breakfast', hours: '8:00-15:00', dayBadge: { text: '行列予想', kind: 'hot' }, url: 'https://www.sqirlla.com', insta: '@sqirlla' },
    { name: 'Republique',            desc: '美しい歴史的建築の中のフレンチカフェ',             area: 'Mid-Wilshire', distance: '車 15分',   mode: 'car',  icon: Coffee, cat: 'food',    rating: 4.6, price: '$15~', scene: 'food_breakfast', hours: '8:00-23:00', dayBadge: { text: '営業中', kind: 'open' }, url: 'https://republiquela.com', insta: '@republiquela' },
    { name: 'Bottega Louie',         desc: '大理石の店内とマカロンで映える朝食',               area: 'DTLA',         distance: '徒歩 8分',  mode: 'walk', icon: Coffee, cat: 'food',    rating: 4.4, price: '$18~', scene: 'food_breakfast', hours: '8:00-23:00', dayBadge: { text: '予約推奨', kind: 'hot' }, url: 'https://bottegalouie.com', insta: '@bottegalouie' },
    { name: 'Cofax Coffee',          desc: 'ドーナツとコーヒーで朝の小休止',                   area: 'Fairfax',      distance: '車 20分',   mode: 'car',  icon: Coffee, cat: 'food',    rating: 4.5, price: '$8~', scene: 'food_breakfast', hours: '7:00-15:00', dayBadge: null, url: 'https://www.cofaxcoffee.com', insta: '@cofaxcoffee' },
  ],
  lunch: [
    ...
    { name: 'Philippe the Original', desc: '1908年創業、フレンチディップ発祥の店',             area: 'Chinatown',    distance: '車 5分',    mode: 'car',  icon: Pizza, cat: 'food',     rating: 4.5, price: '$10~', scene: 'food_burger', hours: '6:00-22:00', dayBadge: { text: '営業中', kind: 'open' }, url: 'https://www.philippes.com', insta: '@philippestheoriginal' },
    ...
    { name: 'Mendocino Farms',       desc: 'カリフォルニア式サンドイッチでヘルシーに',         area: 'DTLA',         distance: '徒歩 10分', mode: 'walk', icon: Pizza, cat: 'food',     rating: 4.6, price: '$12~', scene: 'food_burger', hours: '11:00-21:00', dayBadge: null, url: 'https://www.mendocinofarms.com', insta: '@mendocinofarms' },
    { name: 'In-N-Out Burger',       desc: 'カリフォルニア定番。Double-Doubleを',              area: '各地',          distance: '車 15分',   mode: 'car',  icon: Pizza, cat: 'food',     rating: 4.5, price: '$8~', scene: 'food_burger', hours: '10:30-1:00', dayBadge: null, url: 'https://www.in-n-out.com', insta: '@innout' },
    { name: 'Guisados',              desc: '本場メキシカン・タコスの名店',                     area: 'Boyle Heights',distance: '車 10分',   mode: 'car',  icon: Pizza, cat: 'food',     rating: 4.6, price: '$10~', scene: 'food_taco', hours: '11:00-22:00', dayBadge: { text: '営業中', kind: 'open' }, url: 'https://www.guisados.co', insta: '@guisadostacos' },
  ],
  dinner: [
    ...
    { name: 'Daikokuya Ramen',       desc: 'リトル東京の老舗ラーメン。トンコツ系',             area: 'Little Tokyo', distance: '徒歩 15分', mode: 'walk', icon: Wine, cat: 'food',      rating: 4.4, price: '$15~', scene: 'food_sushi', hours: '11:00-24:00', dayBadge: { text: '深夜営業', kind: 'open' }, url: 'https://www.daikoku-ten.com', insta: '@daikokuyaramen' },
  ...
  morning: {
    art: [
      ...
      { name: 'MOCA Grand Avenue',    desc: '現代美術の常設展と特別展。建築も見もの',          area: 'DTLA',         distance: '徒歩 10分', mode: 'walk', icon: Palette, cat: 'art',     rating: 4.4, price: '$15~', scene: 'art', hours: '11:00-18:00', dayBadge: { text: '営業中', kind: 'open' }, url: 'https://www.moca.org', insta: '@moca' },
    ...
    movie: [
      ...
      { name: 'Warner Bros. Studio Tour',desc: '映画スタジオの裏側を見学。要予約',             area: 'Burbank',      distance: '車 30分',   mode: 'car',  icon: Clapperboard, cat: 'movie',rating: 4.7, price: '$60~', scene: 'hollywood', hours: '9:00-16:00', dayBadge: { text: '予約必須', kind: 'hot' }, url: 'https://www.wbstudiotour.com', insta: '@wbtourhollywood' },
    ],
    photo: [
    ...
    sports: [
      { name: 'Dodger Stadium ツアー', desc: 'MLB球場の裏側を見学。ベンチ・記者室・記念室',    area: 'Elysian Park', distance: '車 10分',   mode: 'car',  icon: Trophy, cat: 'sports',  rating: 4.7, price: '$25~', scene: 'skyline', hours: '10:00-15:00（試合日除く）', dayBadge: { text: '試合日制限', kind: 'closed' }, url: 'https://www.mlb.com/dodgers/ballpark/tours', insta: '@dodgers' },
    ...
    experience: [
      { name: 'Wi Spa Korean Sauna',  desc: '24時間営業の韓国スパ。岩盤浴と汗蒸幕',             area: 'Koreatown',    distance: '車 15分',   mode: 'car',  icon: Compass, cat: 'experience',rating: 4.3, price: '$40~', scene: 'historic', hours: '24時間', dayBadge: { text: '24h営業', kind: 'open' }, url: 'https://www.wispausa.com', insta: '@wi_spa_la' },
  ...
  afternoon: {
    art: [
      { name: 'LACMA',                desc: 'Urban Lightの前で写真。コレクションも巨大',       area: 'Mid-Wilshire', distance: '車 20分',   mode: 'car',  icon: Palette, cat: 'art',     rating: 4.5, price: '$25~', scene: 'art', hours: '11:00-18:00', dayBadge: { text: '営業中', kind: 'open' }, url: 'https://www.lacma.org', insta: '@lacma' },
      ...
      { name: 'Academy Museum',       desc: '映画芸術科学アカデミー博物館。映画好き必訪',      area: 'Mid-Wilshire', distance: '車 20分',   mode: 'car',  icon: Palette, cat: 'art',     rating: 4.6, price: '$20~', scene: 'hollywood', hours: '10:00-18:00', dayBadge: { text: '営業中', kind: 'open' }, url: 'https://www.academymuseum.org', insta: '@academymuseum' },
    ],
    nature: [
      { name: 'Huntington Library',   desc: '日本庭園・中国庭園が美しい広大なエステート',      area: 'San Marino',   distance: '車 30分',   mode: 'car',  icon: Mountain, cat: 'nature',  rating: 4.8, price: '$25~', scene: 'mountain', hours: '10:00-17:00', dayBadge: { text: '営業中', kind: 'open' }, url: 'https://www.huntington.org', insta: '@thehuntingtonlibrary' },
    ...
    beach: [
      { name: 'El Matador State Beach',desc: 'マリブの隠れ家ビーチ。岩のアーチが絵になる',      area: 'Malibu',       distance: '車 50分',   mode: 'car',  icon: Waves, cat: 'beach',    rating: 4.7, price: '駐車場$8~', scene: 'beach', hours: '日の出-日没', dayBadge: null, url: 'https://www.parks.ca.gov/?page_id=619', insta: null },
    ...
    photo: [
      ...
      { name: 'Salt & Straw Venice', desc: 'ピンク壁とアイスクリーム。並んでも撮りたい',      area: 'Venice',       distance: '車 35分',   mode: 'car',  icon: Camera, cat: 'photo',   rating: 4.6, price: '$5~', scene: 'shopping', hours: '11:00-23:00', dayBadge: { text: '営業中', kind: 'open' }, url: 'https://saltandstraw.com', insta: '@saltandstraw' },
    ...
    sports: [
      ...
      { name: 'SoFi Stadium ツアー',  desc: 'Rams/Chargersの最新スタジアム。建築自体が見もの', area: 'Inglewood',    distance: '車 25分',   mode: 'car',  icon: Trophy, cat: 'sports',  rating: 4.6, price: '$40~', scene: 'themepark', hours: '10:00-15:00', dayBadge: null, url: 'https://www.sofistadium.com', insta: '@sofistadium' },
    ],
    experience: [
      { name: 'クッキングクラス（メキシカン）', desc: '本場の料理人と作るタコス・サルサ・モレ', area: 'Boyle Heights',distance: '車 10分',   mode: 'car',  icon: Compass, cat: 'experience',rating: 4.8, price: '$60~', scene: 'food_taco', hours: '14:00-17:00', dayBadge: { text: '予約必須', kind: 'hot' }, url: 'https://www.google.com/search?q=Los+Angeles+mexican+cooking+class', insta: null },
      { name: 'E-Bike Tour（DTLA）',  desc: '電動アシスト自転車で2時間DTLAをガイドツアー',    area: 'DTLA',         distance: '徒歩 5分',  mode: 'walk', icon: Compass, cat: 'experience',rating: 4.7, price: '$50~', scene: 'skyline', hours: '10:00 / 14:00', dayBadge: null, url: 'https://www.google.com/search?q=Los+Angeles+ebike+tour', insta: null },
      { name: 'Pottery Workshop',     desc: '陶芸ワークショップ。1日でカップやボウルを作る',    area: 'Echo Park',    distance: '車 10分',   mode: 'car',  icon: Compass, cat: 'experience',rating: 4.8, price: '$45~', scene: 'art', hours: '13:00-16:00', dayBadge: null, url: 'https://www.google.com/search?q=Los+Angeles+pottery+workshop', insta: null },
      { name: 'Old Town Music Hall', desc: '1920年代の映画を生伴奏で。週末限定の貴重な体験',  area: 'El Segundo',   distance: '車 35分',   mode: 'car',  icon: Compass, cat: 'experience',rating: 4.9, price: '$8~', scene: 'hollywood', hours: '週末 14:30 / 20:00', dayBadge: { text: '週末限定', kind: 'event' }, url: 'https://oldtownmusichall.org', insta: null },
    ],
  },
  evening: [
    ...
    { name: 'OUE Skyspace（DTLA夜景）',desc: '高層ビル屋上の展望台とガラススライダー',          area: 'DTLA',         distance: '徒歩 10分', mode: 'walk', icon: Moon, cat: 'movie',    rating: 4.4, price: '$20~', scene: 'night_city', hours: '10:00-22:00', dayBadge: null, url: 'https://oue-skyspace.com', insta: '@oueskyspacela' },
...
const TODAYS_EVENTS = [
  ...
  { time: '終日',  title: '特別展: Kusama "New Works"', venue: 'The Broad',              scene: 'art',         cat: 'art',       ticketsLeft: '当日整理券',     price: '$15~',      url: 'https://www.thebroad.org',                       insta: '@thebroadmuseum' },
      ...
      <section id="sec-howto" className="px-6 py-10" style={{ background: C.paper, borderBottom: `1px solid ${C.line}`, scrollMarginTop: 12 }}>
        ...
        <div className="space-y-3">
          {[
            ...
            { en: 'PRICE',       jp: '料金はあくまで目安',   desc: '各スポットの料金（$表記）は「最低でもこれくらいから」という下限の目安です。「$15~」なら15ドル前後から。時期・メニュー・席種で変わるため、正確な料金は公式サイトでご確認ください。' },
          ].map((step, i) => (
